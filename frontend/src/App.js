...
function ProtectedRoute({ children }) {
  ...
  if (!user)   return <Navigate to="/" state={{ openModal: true }} replace />;
  return children;
}

function Spinner() {
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#080C10", display: "flex", alignItems: "center", justifyContent: "center" }}>
...
function TopBar() {
  ...
  const dropdown = showMenu ? ReactDOM.createPortal(
    <>
      ...
      <div style={{ position: "fixed", top: menuPos.top, right: menuPos.right, width: "220px", backgroundColor: "#0D1117", border: "1px solid #21262D", borderRadius: "10px", boxShadow: "0 20px 60px rgba(0,0,0,0.7)", zIndex: 9999, overflow: "hidden" }}>
        <div style={{ padding: "14px 16px", borderBottom: "1px solid #21262D" }}>
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: "13px", fontWeight: 600, color: "#E6EDF3", margin: "0 0 2px" }}>{user?.name}</p>
          <p style={{ fontFamily: "Inter, sans-serif", fontSize: "11px", color: "#7D8590", margin: 0 }}>{user?.email}</p>
        </div>
  ...
  return (
    <>
      <header style={{ height: "60px", borderBottom: "1px solid #21262D", backgroundColor: "#0D1117", position: "sticky", top: 0, zIndex: 10 }}>
        <div style={{ maxWidth: "1180px", margin: "0 auto", padding: "0 40px", height: "100%", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "16px", flexShrink: 0 }}>
            ...
            <button ref={avatarRef} onClick={handleAvatarClick}
              ...
              <div style={{ width: "30px", height: "30px", borderRadius: "50%", backgroundColor: "rgba(240,165,0,0.15)", border: "1px solid rgba(240,165,0,0.3)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span style={{ fontFamily: "JetBrains Mono, monospace", fontSize: "11px", fontWeight: 700, color: "#F0A500" }}>{initials}</span>
              </div>
              <span style={{ fontFamily: "Inter, sans-serif", fontSize: "13px", color: "#7D8590", fontWeight: 500 }}>{firstName}</span>
